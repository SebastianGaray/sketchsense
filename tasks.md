...
- [x] **T031** Train, evaluate, and release model v2 only after fresh-test quality, parity, size, latency, privacy, and browser checks pass.
- [x] **T032** Split Canvas, Examples, Model, and About into bilingual routes with one persistent menu and direct return navigation to Canvas. (SS-FR-012)
